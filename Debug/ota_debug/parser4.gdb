...
# boot normally so InitHardware() has run
monitor reset run
...
set {char[62]}0x20000510 = "version=3;url=/firmware/fw_v3.hex;crc32=21657c40;size=171335\n"
set G_u16RxRead = 0
set G_u16RxWrite = 61
set {char[64]}0x20000d88 = "SENTINEL-UNTOUCHED"
set $rc = (int)WaitForHttpBody((char*)0x20000d88, 64)
...
set {char[29]}0x20000510 = "state=DEAD;game=none;time=x\n"
set G_u16RxRead = 0
set G_u16RxWrite = 28
set {char[64]}0x20000d88 = "SENTINEL-UNTOUCHED"
set $rc = (int)WaitForHttpBody((char*)0x20000d88, 64)
